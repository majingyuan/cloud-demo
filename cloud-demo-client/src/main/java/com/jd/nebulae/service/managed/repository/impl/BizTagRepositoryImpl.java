...
//    public List<JSONObject> getParentByTopId(){
...
//    public List<JSONObject> getParentByTopId(Long topId){
//        List<TagType> results = Lists.newArrayList();
//
//        String sql = "select * from nebulae_biz_line where top_id = "+topId;
//
//        try {
//            results = getJdbcTemplate().query(sql, new Object[]{topId}, new JsonMapper());
//        }catch (Exception ex) {
//            log.error("BizTagRepositoryImpl_updateTagType error: " + ex.getStackTrace());
//            throw new RuntimeException(ex);
//        }
